...
public class LMSController {
    ...
    public LMSController(StudentService studentService, LecturerService lecturerService) {
    ...
    public String createUser(@RequestParam String name, @RequestParam Long number, @RequestParam String email, @RequestParam String role, @RequestParam String password){
